...
FOR EACH ROW
 ...
 BEGIN
    ...
    FECHA, 'USUARIOS',:new_buffer.ID ,'INSERTAR',USUARIO, IP);
 ...
 END;
  ...
  values ('1035864304','CEDULA CIUDADANIA','MEDELLIN',to_date('15/05/97','DD/MM/RR'),'COLOMBIANA','RONALD','ALONSO','RENDON','ATEHORTUA',to_date('15/05/97','DD/MM/RR'),'Mingoyo','452 Superior Way','63766 Mayer Drive','QSeTJiX9t','rcoselye@youtube.com','ESPANOL','1542203811','1','1','SENOR','\DOCUMENTOS\DOC15','1','0','3','3');

  SELECT * FROM USUARIOS WHERE DOCUMENTO = '1035864304'
  
  SELECT * FROM AUDITORIA
  
  DELETE FROM USUARIOS WHERE DOCUMENTO = '1035864304'
