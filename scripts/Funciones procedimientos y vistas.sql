   ...
   CREATE OR REPLACE PROCEDURE PROCESAR_RETIROS (MONTO NUMBER, V_ID_USUARIO NUMBER, BANCO VARCHAR2, CUENTA VARCHAR2, V_ID_COMPROBANTE NUMBER) IS
    ...
    BEGIN
     ...
     IF SALDO_USUARIO = 0 OR SALDO_USUARIO < MONTO  THEN
          ...
          SELECT COUNT (*) INTO NUM_REGISTROS FROM RETIROS WHERE ID_USUARIO = V_ID_USUARIO;
       ...
       ELSE 
          CONSULTA2 := 'UPDATE RETIROS SET ESTADO = ''RECHAZADO'', OBSERVACIONES = ''NO TIENE SALDO SUFICIENTE'' WHERE ID = '|| V_ID_USUARIO;
       END IF;
...
<<<<<<< HEAD
          ...
          VALIDAR_COMPROBANTES(V_ID_USUARIO);
=======
...
>>>>>>> cdf3bf1643a3a39d55760cbc2cedc089a18b796c
 ...
 CREATE OR REPLACE PROCEDURE VALIDAR_COMPROBANTES(V_ID_USUARIO NUMBER) 
 IS
