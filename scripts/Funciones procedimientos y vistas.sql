...
BEGIN
    ...
    SELECT APU.ID_USUARIO, PA.ID, SUM(DAP.CUOTA_GANADORA * DAP.VALOR_APOSTADO)
    ...
    WHERE DAP.ESTADO = 'GANADO' AND PA.ID = 1
    GROUP BY APU.ID_USUARIO, PA.ID
    ORDER BY APU.ID_USUARIO, PA.ID 
END;
