...
BEGIN
  ...
  IF INSERTING THEN
    ...
    SELECT VALOR_TOTAL INTO VALOR FROM APUESTAS;   
 ...
 END IF;
  ...
  IF UPDATING THEN 
    ...
    SELECT TOTAL_GANANCIAS - VALOR_TOTAL INTO VALOR FROM APUESTAS;
    UPDATE USUARIOS SET SALDO = SALDO + VALOR  WHERE ID= :new.ID_USUARIO;
 ...
 DELETE USUARIOS WHERE ID = '1007'
 
 SELECT SALDO FROM USUARIOS WHERE ID = '1008'
 
 UPDATE USUARIOS SET SALDO = 1000000 WHERE DOCUMENTO = '1017210416';
 ...
 values (1008,'200000','136000',to_date('18/07/19','DD/MM/RR'),'3','1');
